...
import co.com.tactusoft.crm.postsale.bo.BillingBO;
...
public class Billing {
	...
	public static void main(String[] args) {
		Billing billing = new Billing("1000", "30");
		List<CrmCalcSchemeResult> result = billing.execute("400446", 50000d);
		System.out.println("Total: " + result.get(0).getAmount());
	}
